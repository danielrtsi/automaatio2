...
public class LegoBuffer {
    ...
    public LegoBuffer(AssetManager assetManager, Node rootNode, float xOffset, float zOffset, int rowSize, int columnSize, boolean fillWithLegos) {
    ...
    Vector3f getLegoCenterLocation(int i) {
